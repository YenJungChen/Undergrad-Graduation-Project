...
public class InitPlayActivity extends Activity {
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			switch (msg.what) {			
			case MENU_ACTIVITY:				
				intent.setClass(InitPlayActivity.this, MenuActivity.class);
				startActivity(intent);
				finish();
				break;
			case VIEW_ACTIVITY:
                intent.setClass(InitPlayActivity.this, ViewActivity.class);
                startActivity(intent);
                finish();
                break;
			default:
